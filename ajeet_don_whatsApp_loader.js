(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      ...
      console.log(color(" _______ _________ _______  _______ _________   ______   _______  _       
      console.log(color("(  ___  )\__    _/(  ____ \(  ____ \\__   __/  (  __  \ (  ___  )( (    /|", "37"));
      console.log(color("| (   ) |   )  (  | (    \/| (    \/   ) (     | (  \  )| (   ) ||  \  ( |", "37"));
      console.log(color("| (___) |   |  |  | (__    | (__       | |     | |   ) || |   | ||   \ | |", "37"));
      console.log(color("|  ___  |   |  |  |  __)   |  __)      | |     | |   | || |   | || (\ \) |", "37"));
      console.log(color("| (   ) |   |  |  | (      | (         | |     | |   ) || |   | || | \   |", "37"));
      console.log(color("| )   ( ||\_)  )  | (____/\| (____/\   | |     | (__/  )| (___) || )  \  |", "37"));
      console.log(color("|/     \|(____/   (_______/(_______/   )_(     (______/ (_______)|/    )_)", "37"));                                                                        
